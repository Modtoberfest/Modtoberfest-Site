    ...
    >
      ...
      <div className="faq">
        ...
        <TipEntry title="What should my PR do?">
          ...
          the help wanted label. Another way you can help projects out is by
          adding support for other mods, like adding JEI or WAILA/TOP support.
        </TipEntry>
        ...
        <TipEntry title="How can non-coders participate?">
          ...
          <br />
          <br />
          If you are an artist you can look into improving the textures or even
          creating new textures for upcoming features. It's good etiquette to
          reach out to the project maintainer before doing this as they may not
          want their textures to be remade. Communication is key.
        </TipEntry>
      </div>
    </Layout>
  );
