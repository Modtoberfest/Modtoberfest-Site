    ...
    >
      ...
      <div className="faq">
        <FAQItem title="What is Modtoberfest?">
          ...
          challenge which has similar goals.
        </FAQItem>
        ...
        <FAQItem title="What time zone does the event use?">
          ...
          for the event. All pull request data is taken from GitHub's API which
          also uses UTC. Please keep in mind that time is tricky and some
        ...
        <FAQItem title="Do commits count?">
          No, we will only be tracking pull requests. Additionally pull requests
          will only contribute to the challenge score of the pull request's
          author.
        </FAQItem>
